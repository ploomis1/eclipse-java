...
* Sets isCompleted to false if there are no more questions after returning; * @return the next question that should be answered.
*/
public IQuestion getNextQuestion(); /**
* sets the isStarted variable to true if it is false and returns the current question * @return the current question waiting for an answer.
*/
public IQuestion getCurrentQuestion(); /**
* @return the answer to the current question
*/
public String getCurrentAnswer(); /**
* checks if the user input matches the question's answer. * @param answer the user input as a string
